...
void minterms(GtkButton* widget, GtkWidget* pWindow) {
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/input_minterm.png");
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/input_expression.png");
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/input_table.png");
...
int main (int argc, char *argv[]) {
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/input.png");
	gtk_table_attach(GTK_TABLE(table), image, 0, 1, 4, 5, GTK_SHRINK, GTK_SHRINK, 50, 10);
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/step1.png");
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/step2.png");
	gtk_table_attach(GTK_TABLE(table), image, 0, 1, 6, 7, GTK_SHRINK, GTK_SHRINK, 50, 10);
	label = gtk_label_new("STEP2");
	gtk_table_attach(GTK_TABLE(table), label, 0, 1, 7, 8, GTK_SHRINK, GTK_SHRINK, 50, 10);


	image = gtk_image_new_from_file("/home/rushikesh/gtk/step3.png");
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/step4.png");
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/step5.png");
	...
	image = gtk_image_new_from_file("/home/rushikesh/gtk/step6.png");
